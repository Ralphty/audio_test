...
int main(int argc, char *argv[])
{
	...
	/* Set period size to 32 frames. */
    	frames = 32;
    	periodsize = frames*2 ;
    	//ret = snd_pcm_hw_params_set_buffer_size_near(playback_handle, hw_params, &periodsize,&dir);
    	//if (ret < 0) 
    	//{
    	...
    	ret = snd_pcm_hw_params_set_period_size_near(playback_handle, hw_params, &periodsize, &dir);
    	if (ret < 0) 
    	{
