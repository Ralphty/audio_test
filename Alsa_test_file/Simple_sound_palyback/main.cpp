...
static int set_swparams(snd_pcm_t *handle, snd_pcm_sw_params_t *swparams)
{
        ...
        /* write the parameters to the playback */
                               ...
                               snd_pcm_channel_area_t *areas)
{
        ...
        //ufds = malloc(sizeof(struct pollfd) * count);//originally there
...
static void async_callback(snd_async_handler_t *ahandler)
{
        ...
        //struct async_private_data *data = snd_async_handler_get_callback_private(ahandler);//originally there
...
"\n");
        ...
        for (k = 0; k < SND_PCM_FORMAT_LAST; ++k) {
                //const char *s = snd_pcm_format_name(k);//originally there
    ...
    struct option long_option[] =
           ...
           while (1) {
                   ...
                   case 'm':
                           ...
                           break;
                   case 'o':
                           //for (format = 0; format < SND_PCM_FORMAT_LAST; format++)//originally there
                   for (format = (snd_pcm_format_t)0; format < SND_PCM_FORMAT_LAST;format=(snd_pcm_format_t)(format+1)){
                                   //const char *format_name = snd_pcm_format_name(format);//originally there
           ...
           //samples = malloc((period_size * channels * snd_pcm_format_physical_width(format)) / 8);//originally there
           ...
           //areas = calloc(channels, sizeof(snd_pcm_channel_area_t));//originally there
